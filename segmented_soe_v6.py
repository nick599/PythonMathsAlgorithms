...
def main():
	...
	for segment in segments:	#There are math.ceil(math.sqrt(N)) segments 				
					#-- O(N) since 'x in s' and segments is a list'
		#print'-----------------------------------'
		#print'Segment is: '+str(segment)
		#100 elements in each segment for N=10000 		
		for element in segment:	#There are math.ceil(math.sqrt(N)) elements in each segment apart from the last segment		
					#-- O(N) since 'x in s' and segments is a list'
